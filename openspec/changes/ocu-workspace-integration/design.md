...
Issue17 moves the formerly inline heartbeat into the SPA's managed request effect so it shares the wrapper header and timer cleanup. The old inline location above describes the baseline, not the implemented emission point.
